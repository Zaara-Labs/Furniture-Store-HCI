            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              >
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  At FABRIQUÉ, we believe that your home should be a reflection of your unique personality and style. Our mission is to craft furniture that not only enhances your living spaces but also stands the test of time—both in durability and design.
                </p>
                <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              {[
                {
                  ...
                  description: "We take pride in every piece we create, paying meticulous attention to detail from the initial design to the final production."
                },
                {
                  icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  description: "We&apos;re committed to environmentally friendly practices, using responsibly sourced materials and minimizing waste in our production process."
                },
                {
                  icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  description: "Building long-lasting relationships with our customers through transparency, reliability, and exceptional service is fundamental to our business."
                }
              ].map((value, index) => (
                <motion.div 
                  key={index} 
                ...
                >
                  ...
                  <h3 className="text-xl font-medium text-center mb-4">{value.title}</h3>
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/shop" className="inline-block px-8 py-3 bg-white text-amber-800 font-medium rounded-md hover:bg-amber-50 transition-colors">
                  Explore Collection
                </Link>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/room-designer" className="inline-block px-8 py-3 border-2 border-white text-white font-medium rounded-md hover:bg-amber-700 transition-colors">
                  Try Room Designer
                </Link>
              </motion.div>
            </motion.div>
