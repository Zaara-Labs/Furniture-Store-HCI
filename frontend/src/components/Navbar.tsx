    ...
    <nav className="bg-white py-4 px-6 shadow-sm fixed w-full z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <Link href="/" className="flex items-center">
          <span className="text-2xl font-serif font-medium text-gray-800">PNEUMETRA</span>
        </Link>
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <Link href="/shop" className="text-gray-700 hover:text-amber-800 transition-colors">
            Shop
          </Link>
          <Link href="/collections" className="text-gray-700 hover:text-amber-800 transition-colors">
            Collections
          </Link>
